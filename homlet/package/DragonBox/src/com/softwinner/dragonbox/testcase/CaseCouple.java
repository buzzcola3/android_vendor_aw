...
public class CaseCouple extends IBaseCase {
	...
	public void onStartCase() {
        ...
        String coupleResult = SystemProperties.get(COUPLE_RESULT,COUPLE_NOT_TEST);
        ...
        if(COUPLE_NOT_TEST.equals(coupleResult)) {//couple not test
        	...
        	if(results!=null&&results.length==2) {
        		...
        		if(COUPLE_PASS.equals(mResult)) {//pass
                	...
                	setCaseResult(true);
                	mMinCoupleInfo.setText(mContext.getString(R.string.case_couple_info,results[1],results[0]));
                	mMaxCoupleInfo.setText(mContext.getString(R.string.case_couple_info,results[1],results[0]));
