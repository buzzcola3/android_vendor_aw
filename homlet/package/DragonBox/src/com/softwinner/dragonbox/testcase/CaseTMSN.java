...
public class CaseTMSN extends IBaseCase {
    ...
    public static final String HDCPKEY_KEY = "hdcpkey";
    public static final String WIFI_MAC_KEY = "wifi_mac";
    public static final String MAC_KEY = "mac";
    public static final String SN_KEY = "serialno";
    private ReadPrivateJNI mReadPrivateJNI = DragonBoxMain.getReadPrivateJNI();
	...
	public void onStartCase() {
        ...
        String rotpk = getRotpk(ROTPK_PATH);
        ...
        if(sn==null) {
        	...
        	//for test
        	//DragonBoxMain.getTestResultforSQLInfo().putOneInfo(DragonBoxMain.getTestResultforSQLInfo().mLegalKey[1], "87654321");
        }
