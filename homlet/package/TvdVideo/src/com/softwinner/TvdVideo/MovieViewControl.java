...
/*        mVideoView.setBDFolderPlayMode(intent.getBooleanExtra(MediaStore.EXTRA_BD_FOLDER_PLAY_MODE,
    ...
    private Uri uri2File2Uri(Uri videoUri) {
        ...
        if (scheme.equals("content")) {
            ...
            String[] videoProjection = new String[] {MediaStore.MediaColumns.DISPLAY_NAME};
            try {
                c = mMediaProvider.query(null, videoUri, videoProjection, null, null);
    ...
    public int getListMode3D (){
        displayManager = new DisplayOutputManager();
        boolean is3DMode = displayManager.isCurrent3Doutput(0);
        int currentMode;
        if(is3DMode){
                currentMode = 1;
        }else{
        ...
        editor.putInt(EDITOR_MODE2DOR3D, currentMode);
        editor.commit();
        return currentMode;
    }
    @Override
