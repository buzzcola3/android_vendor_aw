...
LOCAL_STATIC_LIBRARIES := libexfat $(libexfat_shared_libraries)
...
########################################
# executable: mount.exfat-fuse

fuse_src_files := fuse/main.c
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := $(fuse_src_files)
LOCAL_CFLAGS := $(exfat_common_cflags)
LOCAL_C_INCLUDES := $(fuse_headers)
LOCAL_STATIC_LIBRARIES := libexfat libfuse $(libexfat_shared_libraries)
